...
public class MethodContext<T, P> extends ExecutableElementContext<Method, P> implements TypedElementContext<T> {
    ...
    public TypeContext<T> genericReturnType() {
        if (this.genericReturnType == null) {
            ...
            if (genericReturnType instanceof Class) this.genericReturnType = TypeContext.of((Class) genericReturnType);
