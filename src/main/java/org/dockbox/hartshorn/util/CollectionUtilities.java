...
public final class CollectionUtilities {
    ...
    public static <T> T[] merge(final T[] arrayOne, final T[] arrayTwo) {
        ...
        merged.addAll(Arrays.asList(arrayOne));
        merged.addAll(Arrays.asList(arrayTwo));
    ...
    public static <T> Set<T> difference(final Collection<T> collectionOne, final Collection<T> collectionTwo) {
        ...
        return Collections.unmodifiableSet(new HashSet<>(CollectionUtilities.merge(differenceInOne, differenceInTwo)));
    }
